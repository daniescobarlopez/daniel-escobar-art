...
const artworks: Artwork[] = [
  ...
  },
  {
    ...
    fullDescription: "Mi abuelo Martín tiene 3 hijos, 6 nietos y 4 bisnietos.\n\nEn las fechas señaladas siempre nos juntábamos en su casa. Recuerdo que me encantaba, porque significaba que iba a reunirme con mis primos.\n\nEl salón se llenaba de alegría. Los niños cenábamos en la mesa de los niños y, cuando era Navidad, dormíamos todos juntos en la sala de estar.\n\nA las 14:30, como muy tarde, se comía. Las manos encima de la mesa y los cubiertos se entregaban ofreciendo el mango.\n\nNunca he visto a mis abuelos gritar, ni mucho menos levantar una mano. Eso sí, mi abuelo te echaba una mirada y se te quitaban las ganas de hacer trastadas.\n\nDe pequeño pasaba temporadas viviendo en su casa y estoy eternamente agradecido por la educación que me han dado. En su momento no era consciente, pero sé que la persona que soy a día de hoy es, en gran parte, gracias a mis abuelos.\n\nCon muchísimo cariño, este retrato va dedicado a mi abuelo Martín por su 87.º cumpleaños. Todo un titán. Un referente del saber estar, siempre con una sonrisa y bromeando incluso en los peores momentos.\n\nTe quiero mucho, abuelo.",
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            <div className={`relative w-full lg:col-span-6`}>
              <div
                className={`relative overflow-hidden lg:sticky lg:top-32 ${artwork.imageAspect === "landscape" ? "bg-transparent" : "bg-muted aspect-[4/5]"
                  }`}
              >
                ...
                <div className="mb-4">
                  ...
                  {artwork.price && (
                    <p className="text-sm text-muted-foreground font-medium flex items-center gap-2">
                      Precio:
                      {artwork.originalPrice && <span className="line-through opacity-70">{artwork.originalPrice}</span>}
